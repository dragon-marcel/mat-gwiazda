    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 p-6">
      <div className="w-full max-w-md bg-white dark:bg-slate-800 rounded-md shadow-md p-6">
        <header className="mb-6 flex items-center justify-between">
          <h2 className="text-lg font-semibold">Zaloguj się do <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">Mat-Gwiazda</span><Stars count={1}  inline /></h2>
        </header>
        ...
        <form className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <Button size="lg">Zaloguj</Button>
            <Button variant="link" size="sm">Zarejestruj się</Button>
          </div>
        </form>
      </div>
    </div>
